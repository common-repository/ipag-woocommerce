...
?>
    ...
    if (!empty($allow_saved_cards) && !empty($saved_cards)) {
        ?>
            ...
            <Fieldset data-form-ipag class="saved-cards-form-ipag" style="max-width: 300px; margin: 1.15rem auto 1.75rem; padding: 0;">
    ...
    <label for="ipag_saved_card_option_new" class="wc-ipag-card-option-label">
        <?= _e('Novo Cartão', 'ipag-gateway') ?>
    </label>

    <fieldset data-form-ipag id="ipag-credito-payment-form" class="ipag-payment-form" style="max-width: 300px; margin: 1.5rem auto 0; padding: 0; <?= !empty($saved_cards) ? 'display: none;' : '' ?>">
